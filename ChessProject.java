...
public class ChessProject extends JFrame implements MouseListener, MouseMotionListener {
    ...
    //Declaring the instances for the player turn system
    boolean whiteMove;
    boolean possible;
    ...
    */
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        */
		...
		// Making White move first in the player turn system
        if(whiteMove){
		...
		if(possible){ // The "possible" wrapper is for the turn system
			...
			if (pieceName.contains("King")) { //Start of King Code
				if ((landingX == (startX + 1)) || (landingY == (startY + 1) || landingX == (startX - 1)) ||(landingY == (startY - 1))) {
					...
					// checking if to see if the Oponent is white or black - "friendly or enemy"
					if (piecePresent(e.getX(), e.getY())) {
						if (pieceName.contains("White")) {
			...
			else if (pieceName.contains("Queen")) { //Start of Queen Code
				int newY = e.getY() / 75;
				int newX = e.getX() / 75;
				boolean inTheWay = false;
				// Movement of Bishop starts here
				...
				if (((newX < 0) || (newX > 7)) || ((newY < 0) || (newY > 7))) {
					...
					if (Math.abs(startX - newX) == Math.abs(startY - newY)) {
						...
						if (inTheWay) {
							...
							if (piecePresent(e.getX(), (e.getY()))) { // checking if to see if the Oponent is white or black - "friendly or enemy"
								if (pieceName.contains("White")) {
			...
			else if (pieceName.contains("Rook")){ //Start of Rook Code
				Boolean inTheWay = false;
				if(((landingX < 0) || (landingX > 7))||((landingY < 0)||(landingY > 7))){
					...
					if(((Math.abs(startX-landingX)!=0)&&(Math.abs(startY-landingY) == 0))|| (Math.abs(startX-landingX)==0)&&(Math.abs(landingY-startY)!=0))
					{
						...
						else{ // checking if to see if the Oponent is white or black - "friendly or enemy"
							if(piecePresent(e.getX(), (e.getY()))){
								if(pieceName.contains("White")){
									if(checkWhiteOponent(e.getX(), e.getY())){
										validMove = true;
			...
			else if (pieceName.contains("Bishop")) { //Start of Bishop Code
				Boolean inTheWay = false;
				...
				if (((landingX < 0) || (landingX > 7)) || ((landingY < 0) || (landingY > 7))) {
					...
					if (Math.abs(startX - landingX) == Math.abs(startY - landingY)) {
						...
						else if (piecePresent(e.getX(), (e.getY()))) { // checking if to see if the Oponent is white or black - "friendly or enemy"
							if (pieceName.contains("White")) {
								if (checkWhiteOponent(e.getX(), e.getY())) {
									validMove = true;
								}
			...
			else if (pieceName.contains("Knight")) { //Start of Knight Code
				if (((landingX < 0) || (landingX > 7)) || ((landingY < 0) || landingY > 7)) {
					validMove = false;
				}
				else if (((landingX == startX + 1) && (landingY == startY + 2)) || ((landingX == startX - 1) && (landingY
			...
			else if(pieceName.equals("BlackPawn")){ //Start of BlackPawn Code
			...
			else if (pieceName.equals("WhitePawn")) { //Start of WhitePawn Code
